public class Federation {
    ...
    public int getBoardMembersNumber() {
        return boardMembersNumber;
    }

    public void setBoardMembersNumber(int boardMembersNumber) {
        this.boardMembersNumber = boardMembersNumber;
    }
    ...
    public String toString() {
        return "Federation{" +
                ...
                ", boardMembersNumber=" + boardMembersNumber +
